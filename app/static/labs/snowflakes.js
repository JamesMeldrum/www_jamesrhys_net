...
function init() {
  ...
  container.className += ' snowBox';
	...
	sprite1 = THREE.ImageUtils.loadTexture( "/static/labs/textures/snowflake1.png" );
	sprite2 = THREE.ImageUtils.loadTexture( "/static/labs/textures/snowflake2.png" );
